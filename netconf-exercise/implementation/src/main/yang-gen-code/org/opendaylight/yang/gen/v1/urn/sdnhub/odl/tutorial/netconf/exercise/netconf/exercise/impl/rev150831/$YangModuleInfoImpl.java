package org.opendaylight.yang.gen.v1.urn.sdnhub.odl.tutorial.netconf.exercise.netconf.exercise.impl.rev150831 ;
...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "netconf-exercise-impl";
    private final String namespace = "urn:sdnhub:odl:tutorial:netconf-exercise:netconf-exercise-impl";
    private final String revision = "2015-08-31";
    private final String resourcePath = "/META-INF/yang/netconf-exercise.yang";
